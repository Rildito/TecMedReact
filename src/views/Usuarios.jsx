...
export default function Usuarios() {
    ...
    const { filtrado, eliminarUsuario } = useProyect();
                            ...
                            filteredItems.map(user => (
                                <tr className="bg-white border-b" key={user.id}>
                                    ...
                                    <td className="p-2 ">
                                        ...
                                        <button className="bg-red-500 hover:bg-red-700 w-8 h-8 rounded-full" onClick={() => handleDelete(user.nombreCompleto, user.id)}>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-white mx-auto">
